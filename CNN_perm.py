...
def training(net, train_data,labels, learning_rate, epochs):
    ...
    for e in range(0, epochs):
        ...
        print("train: ", (c+f)/data_size*100 , " % donne ", "      with "  , c/(c+f)*100, " % correct ", "loss = ", back)
            
            
            
    return (net,c/(c+f),back)
...
def testing(net, test_data, labels):
    ...
    for e in range(0, epochs):
        ...
        for i,j in enumerate(test_data):
            ...
            back = loss(soft_m, l)
            back.backward()
        print("test: ", (c+f)/data_size*100 , " % donne ", "      with "  , c/(c+f)*100, " % correct ", "loss = ", back)
...
#-----------------------------------------------------------------------------
    ...
    for i in [0.000001, 0.00001, 0.0001,0.001, 0.01, 0.1, 1]:
        ...
        Train_result = training(Network, train_set_data_picture ,train_set_label, i, 15)
        ...
        Results.write("CNN : Testing Network: "+ "learning rate = "+ str(i) + " accurancy = "+ str(Test_result[1]) + " epochs size = "+ str(20) + "\n")
        Results.close()
...
#-----------------------------------------------------------------------------
    ...
    Results = open("CNN_results.txt", "a") 
    Results.write("best epoch size is = ", best_ep[1], " whit an accurancy of: ", best_ep[0] + "\n")
    Results.close()
