...
def main():
    ...
    train_set_data_np = train_set_data_perm_np/255
    
    test_set_data_perm_np = np.asarray(test_set_data_perm)
    test_set_data_np = test_set_data_perm_np/255
    ...
    Results = open("results.txt", "a") 
    Results.write("best Network: "+ "best learning rate = "+ str(best_lr[1]) + " best number of neurons = "+ str(best_ls[1]) + " best epochs size = "+ str(e) + " batch size of 128" + "\n")
    Results.close()
